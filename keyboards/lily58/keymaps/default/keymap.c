 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL,  SE_Z,   SE_X,    SE_C,    SE_V,    SE_B, SE_LABK,  SE_DIAE,  SE_N,    SE_M,    SE_COMM, SE_DOT,  SE_MINS,  KC_RSFT, \
...
[_LOWER] = LAYOUT( \
  ...
  KC_CAPS, SE_SECT, KC_PSCR,   KC_SLCK, KC_INS,  KC_PGUP,                   KC_HOME, _______, _______, _______, _______, SE_QUOT, \
  _______, _______, _______, _______, KC_PAUS, KC_PGDN, _______, _______, KC_END, _______, _______, _______, _______, KC_RCTL, \
...
[_RAISE] = LAYOUT( \
  ...
  _______,   _______,   _______,   _______,  _______,  _______,   _______, _______,  KC_PSLS, KC_PAST, KC_PMNS,  KC_PPLS, KC_RBRC, KC_PENT, \
